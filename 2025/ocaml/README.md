...
3. Replace all instances of `advent_of_code` with your project name, both in files and filenames themselves.
...
├── advent_of_code.install  # autogenerated install script
└── advent_of_code.opam     # autogenerated project description
```
